      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="max-w-3xl text-white space-y-6">
          ...
          <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl">
            Desa ini berada di Kecamatan Bunut, Kabupaten Pelalawan, terdiri dari 2 dusun, 8 RT,
            dan memiliki bentang dataran rendah yang dialiri beberapa sungai menuju kawasan gambut di bagian timur.
          </p>
          <div className="flex flex-wrap gap-4 pt-4">
            <a href="/sejarah" className="bg-primary-container text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 hover:scale-105 transition-transform">
              Baca Sejarah Desa
              <span className="material-symbols-outlined">history_edu</span>
            </a>
            <a href="/gambut" className="border-2 border-white/30 bg-white/10 backdrop-blur-md text-white px-8 py-4 rounded-xl font-bold hover:bg-white/20 transition-all">
              Kenali Gambut Desa
            </a>
          </div>
        </div>
